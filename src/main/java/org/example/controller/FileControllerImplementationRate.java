...
public class FileControllerImplementationRate implements FileController{
    ...
    public ResponseEntity<String> deleteFile(@PathVariable("fileName") String FileName) throws FileNotFoundException, BucketNotFoundException, JsonProcessingException {
    ...
    public ResponseEntity<String> createFile(@PathVariable("fileName") String FileName, @PathVariable("bucketName") String BucketName) throws BucketNotFoundException, JsonProcessingException {
